...
<module external.linked.project.id=":react-native-vector-icons" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" external.system.module.group="ReactNativePrototype" external.system.module.version="unspecified" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7" inherit-compiler-output="false">
    ...
    <orderEntry type="library" exported="" name="react-native-0.29.2" level="project" />
